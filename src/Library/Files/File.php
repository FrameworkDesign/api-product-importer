...
namespace Weareframework\ApiProductImporter\Library\Files;
...
class File
{
    ...
    public function __construct(Config $config, Manager $manager, Yaml $yaml, Sites $sites) {
        ...
        $this->yaml = $yaml;
        $this->configFile = $config->get('statamic.api-product-importer.file');
    ...
    private function file() {
        return base_path("content/api-product-importer/{$this->configFile}_{$this->locale}.yaml");
    }
    ...
    private function cacheKey() {
        return "api_product_importer_settings_{$this->locale}";
    }
}
