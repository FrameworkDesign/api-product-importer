...
@section('content')
    <div class="flex items-center mb-3">
        <h1 class="flex-1">API Product Importer</h1>
    </div>
    <div class="flex items-center mb-3">
        <p>Pull the data in</p>
    </div>
    <div>
        <form action="{{ cp_route('weareframework.api-product-importer.import.upload') }}" method="POST" enctype="multipart/form-data">
            {{ csrf_field() }}
