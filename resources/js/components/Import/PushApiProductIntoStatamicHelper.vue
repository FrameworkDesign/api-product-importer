<template>
    <div class="w-full p-0">
        <div class="flex flex-wrap flex-col">
            <a href="#" @click.prevent="openModal" class="btn btn-sm">Push to Statamic</a>
        </div>
                ...
                <div class="mt-0">
                    <div class="content mb-2">
                            ...
                            <div class="flex gap-2">
                                ...
                                <div class="w-1/2">
                                    ...
                                    <v-select
                                        ...
                                        :options="collections"
                                        :reduce="selection => selection.value"
                                        @input="(value) => this.collection = value"
                                    />
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="mt-2 flex justify-between items-center">
                            ...
                            <button v-if="step < 5 && productDataCollected == true" class="btn w-auto ml-auto flex justify-center items-center" @click="nextStep">
                                Next
                            </button>
                        </div>
                    </div>
